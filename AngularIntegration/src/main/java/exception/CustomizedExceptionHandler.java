...
public class CustomizedExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleEmailException(Exception ex, WebRequest request) throws Exception {
		ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), "Email already exists in DB", request.getDescription(false));
	...
	public final ResponseEntity<Object> handleUserIdNotFound(UserNotFoundException ex, WebRequest request) throws Exception {
